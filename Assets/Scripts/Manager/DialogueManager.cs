...
public class DialogueManager : MonoBehaviour
{
    ...
    private TextAsset currentDialogueJson;
    ...
    private Dictionary<string, DialogueNode> dialogueMap = new Dictionary<string, DialogueNode>();
    ...
    {
        if (nodeId == "exit" || !dialogueMap.ContainsKey(nodeId))
        {
            EndDialogue();
            return;
        }
